...
var pathImg,boyImg,cashImg,diamondsImg,jwelleryImg,swordImg, endImg, gameOverImg, deadBoyImg;
...
function preload(){
  ...
  deadBoyImg = loadImage("deadBoyImg.png");
}
...
swordGroup.setVelocityEach(0)
  ...
  textSize(20);
  fill("white");
  text("Tesouro - "+ treasureCollection, 250, 35)
  }
